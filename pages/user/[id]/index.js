...
const FormUser = () => {
  ...
  const onSubmitForm = async (event) => {
    ...
    try {
      ...
      message.success("Success Create User").then(router.push("/user"));
    } catch (e) {
      ...
      <div className="space-y-10">
        ...
        <div className="bg-white/80 p-14">
          <form onSubmit={onSubmitForm}>
            ...
            <div className="w-full px-4 py-3 mb-5 bg-gray-100 rounded-md">
              <input
                ref={fullNameRef}
            ...
            {/* <div className="w-full px-3 py-3 mb-5 bg-gray-100 rounded-md">
              <Select
                ref={roleIdRef}
                className="w-full"
                placeholder="Select Role"
              >
                <Option value={"6a3fa3d2-3051-46d0-95bf-e13cc522964f"}>
                  Admin
                </Option>
                <Option value={"0171eae9-0968-4ce1-9145-b607a0e1882a"}>
                  User
                </Option>
              </Select>
            </div> */}
